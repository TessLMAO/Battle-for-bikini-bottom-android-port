...
function iconsBruh() --icons at corners of health bar
    if pref.style == 'classicTxt' or 'classicIcons' then
        setProperty('iconP1.x', screenWidth - 225)
        setProperty('iconP1.y', downscroll and 150 or 625)
        scaleObject('iconP1', 0.6, 0.6);

        setProperty('iconP2.x', 75)
        setProperty('iconP2.y', downscroll and 150 or 625)
